<?php 
    ...
    session_start();
    define("APPURL", "http://localhost/web_development01/final_projects/coffee-blend");
    define("IMAGEPRODUCTS", "http://localhost/web_development01/final_projects/coffee-blend/admin-panel/products-admins/images");
